...
For full change list, see https://github.com/midi-horst/midi-horst/pull/2021
...
- add [opencollective](https://opencollective.com/midi-horst-594) banner message display in postinstall script (help support ERB 🙏)
...
- Changed node dev `__dirname` and `__filename` to node built in fn's (https://github.com/midi-horst/midi-horst/pull/1035)
...
- **Renamed `./app/main.development.js` => `./app/main.{dev,prod}.js`:** [#963](https://github.com/midi-horst/midi-horst/pull/963)

#### Fixes

- **Fixed reloading when not on `/` path:** [#958](https://github.com/midi-horst/midi-horst/pull/958) [#949](https://github.com/midi-horst/midi-horst/pull/949)

#### Additions

- **Added support for stylefmt:** [#960](https://github.com/midi-horst/midi-horst/pull/960)
...
- **Added support for debugging production build:** [#fab245a](https://github.com/midi-horst/midi-horst/pull/941/commits/fab245a077d02a09630f74270806c0c534a4ff95)

#### Bug Fixes

- **Fixed bug related to importing native dependencies:** [#933](https://github.com/midi-horst/midi-horst/pull/933)
...
- **Migrated to Jest:** [#768](https://github.com/midi-horst/midi-horst/pull/768)
...
- **Added support for Yarn:** [#451](https://github.com/midi-horst/midi-horst/pull/451)
- **Added support for Flow:** [#425](https://github.com/midi-horst/midi-horst/pull/425)
- **Added support for stylelint:** [#911](https://github.com/midi-horst/midi-horst/pull/911)
- **Added support for electron-builder:** [#876](https://github.com/midi-horst/midi-horst/pull/876)
- **Added optional support for SASS:** [#880](https://github.com/midi-horst/midi-horst/pull/880)
- **Added support for eslint-plugin-flowtype:** [#911](https://github.com/midi-horst/midi-horst/pull/911)
- **Added support for appveyor:** [#280](https://github.com/midi-horst/midi-horst/pull/280)
- **Added support for webpack dlls:** [#860](https://github.com/midi-horst/midi-horst/pull/860)
- **Route based code splitting:** [#884](https://github.com/midi-horst/midi-horst/pull/884)
- **Added support for Webpack Bundle Analyzer:** [#922](https://github.com/midi-horst/midi-horst/pull/922)

#### Improvements

- **Parallelize renderer and main build processes when running `npm run build`**
- **Dynamically generate electron app menu**
- **Improved vscode integration:** [#856](https://github.com/midi-horst/midi-horst/pull/856)

#### Bug Fixes

- **Fixed hot module replacement race condition bug:** [#917](https://github.com/midi-horst/midi-horst/pull/917) [#920](https://github.com/midi-horst/midi-horst/pull/920)

# 0.10.0 (2016.4.18)

#### Improvements

- **Use Babel in main process with Webpack build:** [#201](https://github.com/midi-horst/midi-horst/pull/201)
- **Change targets to built-in support by webpack:** [#197](https://github.com/midi-horst/midi-horst/pull/197)
- **use es2015 syntax for webpack configs:** [#195](https://github.com/midi-horst/midi-horst/pull/195)
- **Open application when webcontent is loaded:** [#192](https://github.com/midi-horst/midi-horst/pull/192)
- **Upgraded dependencies**

#### Bug fixed

- **Fix `npm list electron-prebuilt` in package.js:** [#188](https://github.com/midi-horst/midi-horst/pull/188)
...
- **Upgraded dependencies**
- **Added `npm run dev` command:** [#162](https://github.com/midi-horst/midi-horst/pull/162)
- **electron to v0.37.2**

#### Breaking Changes

- **css module as default:** [#154](https://github.com/midi-horst/midi-horst/pull/154).
- **set default NODE_ENV to production:** [#140](https://github.com/midi-horst/midi-horst/issues/140)
...
- **Fix lint errors**
- **Fix Webpack publicPath for production builds**: [#119](https://github.com/midi-horst/midi-horst/issues/119).
...
- **Add json-loader**: [#128](https://github.com/midi-horst/midi-horst/issues/128).
...
- **Fixed npm script on windows 10:** [#103](https://github.com/midi-horst/midi-horst/issues/103).
- **history and react-router version bump**: [#109](https://github.com/midi-horst/midi-horst/issues/109), [#110](https://github.com/midi-horst/midi-horst/pull/110).
...
- **Fixed process.env.NODE_ENV variable in webpack:** [#74](https://github.com/midi-horst/midi-horst/pull/74).
- **add missing object-assign**: [#76](https://github.com/midi-horst/midi-horst/pull/76).
- **packaging in npm@3:** [#77](https://github.com/midi-horst/midi-horst/pull/77).
- **compatibility in windows:** [#100](https://github.com/midi-horst/midi-horst/pull/100).
- **disable chrome debugger in production env:** [#102](https://github.com/midi-horst/midi-horst/pull/102).
...
- **Initialize ExtractTextPlugin once:** [#64](https://github.com/midi-horst/midi-horst/issues/64).

# 0.6.2 (2015.10.18)

#### Bug fixed

- **Babel plugins production env not be set properly:** [#57](https://github.com/midi-horst/midi-horst/issues/57).
...
- **Run tests with babel-register:** [#29](https://github.com/midi-horst/midi-horst/issues/29).
...
- **Simplify webpack config** see [#50](https://github.com/midi-horst/midi-horst/pull/50).
...
- **Eslint:** typo, [#17](https://github.com/midi-horst/midi-horst/issues/17) and improve `.eslintrc`
...
- **Npm Script:** typo, [#6](https://github.com/midi-horst/midi-horst/pull/6)
- **Missing css:** [#7](https://github.com/midi-horst/midi-horst/pull/7)
